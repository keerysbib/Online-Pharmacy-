            ...
            <p class="card-text">
              ...
              <ul class="list-group list-group-flush">
                <form action="product.php" method="GET">
                  ...
                  <br>
                  <button type="submit" value="buy" name="buy" class="btn btn-primary " style="margin: 5px;">&nbsp; Buy Now &nbsp;</button>
                  <br>
                  <button type="submit" value="" name="cart" class="btn btn-primary " style="margin: 5px;">Add to Cart</button>
                </form>
              </ul>
            <?php
